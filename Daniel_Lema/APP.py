...
def app():
    ...
    Ciudad=st.sidebar.selectbox("Elige Moneda a cambiar", 
                                ["EURO",
                                 "DOLLAR"])
    
    Ciudad=st.sidebar.selectbox("Elige Moneda a recibir", #tenemos que hacer codigo para no poder meter la moneda escrita enteriormente
                                ["EURO",
                                 "DOLLAR"])
